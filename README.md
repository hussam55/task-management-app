...
Task management API built with FastAPI, PostgreSQL, SQLAlchemy, and JWT authentication. This is a simplified Trello-like system with workspaces, projects, and tasks.
